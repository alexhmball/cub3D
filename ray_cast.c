...
/*   Updated: 2023/02/03 18:03:00 by aball            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cast_horizonal(t_data *data)
{
	...
	if (quad == 3 || quad == 4)
	{
		...
		data->player.ray.hx_inc = tan(degtorad(data->player.ray.angle));
	}
	else
	{
		data->player.ray.hy_inc = 1;
...
void	cast_vertical(t_data *data)
{
	...
	if (quad == 3 || quad == 2)
	{
		...
		data->player.ray.vy_inc = tan(degtorad(data->player.ray.angle));
	}
	else
	{
		data->player.ray.vx_inc = 1;
